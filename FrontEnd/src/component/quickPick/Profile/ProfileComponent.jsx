...
import CreatedJobList from './Job/CreatedJobList';
import AppliedJobList from './Job/AppliedJobList';
													...
													<Grid container direction="column" alignItems="flex-start" spacing={2}>
														...
														<Grid item alignContent="flex-start">
															{!this.state.edit_mode ?
																<div align="left">{this.state.userObj.biography !== null ? this.state.userObj.biography : "bio"}</div> :
