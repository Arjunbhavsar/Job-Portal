...
class ProfileComponent extends Component {
	...
	async loadProfile(){
		const file = await FileService.getFile(this.state.userObj.profileFileId)
		this.setState({profileName: file, profile_loaded: true});
	}

	async loadResume(){
		const file = await FileService.getFile(this.state.userObj.resumeFileId)
		this.setState({resumeName: file, resume_loaded: true});
	}
								...
								<Grid container>
									<Grid item sm>
											{this.state.profile_loaded && (
												<img src={this.state.profileName.config.baseURL + this.state.profileName.config.url} alt={this.state.userObj.username + "-profile-image"} style={style.image}/>
											)}
											{!this.state.profile_loaded && (
