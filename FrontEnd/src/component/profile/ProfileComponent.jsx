...
class ProfileComponent extends Component {
	...
	render() {
		...
		const editingFalse = () => (
			<List>
				<ListItem>
					<ListItemAvatar title="name"><AccountCircle fontSize="large" /></ListItemAvatar>
					<ListItemText primary={this.state.userObj.firstName+" "+this.state.userObj.lastName}/>
				</ListItem>
				<Divider variant="inset" component="li" />
				<ListItem>
					<ListItemAvatar title="email"><Email fontSize="large" /></ListItemAvatar>
					<ListItemText primary={this.state.userObj.emailId}/>
				</ListItem>
				<Divider variant="inset" component="li" />
				<ListItem>
					<ListItemAvatar title="address"><ContactMail fontSize="large"/></ListItemAvatar>
			...
			<div className="container">
				<Grid container direction="row">
					...
					<Grid container justify="center">
						<Grid item sm={6}>
							<Paper style={style.Paper}>
								<ProfileJobList jobType="created"/>
							</Paper>
						</Grid>
					</Grid>
					<Grid container justify="center">
						<Grid item sm={6}>
							<Paper style={style.Paper}>
								<ProfileJobList jobType="applied"/>
							</Paper>
						</Grid>
					</Grid>
				</Grid>
